...
function pitch_control()
    ...
    gimbal.pitch_motor.tar_spd = pid_calc(gimbal.pitch_motor.tar_ang, attitude.cannon_ang_imu.pitch, gimbal.pitch_motor.pos_pid)
...
function yaw_control()
    ...
    gimbal.yaw_motor.cur_spd = -yaw.getAngularVelocity()*1.1-attitude.chassis_imu_yaw_spd*0.9

    gimbal.yaw_motor.tar_spd = pid_calc(target.ang.yaw, attitude.cannon_ang_imu.yaw, gimbal.yaw_motor.pos_pid)
