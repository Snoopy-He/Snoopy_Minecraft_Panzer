...
function yaw_control()
    ...
    local pid_output = pid_calc(pid_calc(target.ang.yaw,attitude.cannon_ang_imu.yaw,gimbal.yaw_motor.pos_pid),-yaw.getAngularVelocity()-attitude.chassis_imu_yaw_spd,gimbal.yaw_motor.spd_pid)
    ...
    gimbal.yaw_motor.cur_spd = -yaw.getAngularVelocity()-attitude.chassis_imu_yaw_spd
