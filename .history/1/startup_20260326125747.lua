...
function message_send_task()
    print("sending")
    modem.transmit(1, 1, tostring(chassis.left_tar_spd.." "..chassis.right_tar_spd.." "..gimbal.mode.." "..gimbal.yaw_ang.." "..gimbal.pitch_ang.." "..gimbal.fire_permit))
endmodem.transmit(1, 1, tostring(chassis.left_tar_spd.." "..chassis.right_tar_spd.." "..gimbal.mode.." "..gimbal.yaw_ang.." "..gimbal.pitch_ang.." "..gimbal.fire_permit))
