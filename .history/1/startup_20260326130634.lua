...
function init()
    ...
    modem.open(1)
    modem.open(5)   --gimbal control topic
...
function gimbal_remote_get()
    ...
    if keyboard.button.space then
        gimbal.fire_permit = true
    else
        gimbal.fire_permit = false
    end
...
function message_send_task()
    print("sending")
    modem.transmit(1, 1, tostring(chassis.left_tar_spd.." "..chassis.right_tar_spd.." "..gimbal.mode.." "..gimbal.yaw_ang.." "..gimbal.pitch_ang.." "..gimbal.fire_permit.." "..gimbal.mode.." "..gimbal.yaw_ang.." "..gimbal.pitch_ang.." "..gimbal.fire_permit))
    --modem.transmit(5, 5, tostring(gimbal.mode.." "..gimbal.yaw_ang.." "..gimbal.pitch_ang.." "..gimbal.fire_permit))
    os.sleep(0.05)
end
