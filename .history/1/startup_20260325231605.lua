...
function chassis_speed_set()
    ...
    chassis.left_tar_spd = parameter.chassis.tar_spd - parameter.chassis.tar_turn_spd
    chassis.right_tar_spd = parameter.chassis.tar_spd + parameter.chassis.tar_turn_spd
