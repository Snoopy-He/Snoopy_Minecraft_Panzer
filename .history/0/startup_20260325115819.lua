...
function attitude_calc_task()
    ...
    --attitude.euler = quat_to_euler(attitude.quaternion)
    attitude.euler = mat_to_euler_yxz(attitude.rotate_matrix)
    attitude.omega = ship.getAngularVelocity()
    print(rad_to_deg(attitude.euler.pitch))
